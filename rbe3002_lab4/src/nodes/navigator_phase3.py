...
from rbe3002_lab4.srv import GetPose, GetPoseResponse, NavToPose, NavToPoseResponse, FollowPath, FollowPathResponse, Localize, LocalizeResponse
...
class Navigator:
    ...
    def __init__(self):
        ...
        ### Subscribe to the '/amcl_pose' topic to get robot pose from AMCL node
        ...
        ## Service to localize the robot
        localization_service = rospy.Service('localize', Localize, self.localization_routine)
    ...
    def localization_routine(self, msg):
        numTurns = msg.numTurns
        while (numTurns > 0):
            self.rotate(msg.angle, msg.speed)
            numTurns = numTurns - 1
    ...
    def update_odometry(self, msg):
        ...
        """
        robotPosGC = Coord(msg.pose.pose.position.x, msg.pose.pose.position.y)
        self.px = robotPosGC.x
        self.py = robotPosGC.y
